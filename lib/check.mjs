...
const BUILTIN_CAPABILITIES = {
  ...
  exec: { skill: 'lobster-runtime', path: '__runtime__', builtIn: true },
  'web-search': { skill: 'lobster-runtime', path: '__runtime__', builtIn: true },
  'web-fetch': { skill: 'lobster-runtime', path: '__runtime__', builtIn: true },
};
